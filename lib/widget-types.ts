...
export const DEFAULT_WIDGET_LAYOUT: WidgetConfig[] = [
  { id: 'terminal-sm-1',   type: 'terminal-sm',   x: 0, y: 0,  w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'quick-actions-1', type: 'quick-actions', x: 0, y: 9,  w: 4, h: 6,  minW: 4, minH: 6  },
  { id: 'system-status-1', type: 'system-status', x: 0, y: 15, w: 4, h: 14, minW: 4, minH: 12 },
  ...
  { id: 'help-1',          type: 'help',          x: 4, y: 18, w: 8, h: 5,  minW: 4, minH: 5  },
]
