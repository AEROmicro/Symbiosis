...
export const DEFAULT_WIDGET_LAYOUT: WidgetConfig[] = [
  ...
  { id: 'notes-1',         type: 'notes',         x: 0, y: 28, w: 4, h: 7,  minW: 4, minH: 8, maxH: 8 },
  { id: 'stock-detail-1',  type: 'stock-detail',  x: 4, y: 0,  w: 8, h: 10, minW: 4, minH: 8, maxH: 10 },
  { id: 'watchlist-1',     type: 'watchlist',     x: 4, y: 8,  w: 8, h: 8,  minW: 4, minH: 8  },
  { id: 'heatmap-1',       type: 'heatmap',       x: 4, y: 18, w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'top-movers-1',    type: 'top-movers',    x: 8, y: 18, w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'help-1',          type: 'help',          x: 4, y: 27, w: 8, h: 8,  minW: 8, minH: 6, maxH: 6 },
]
