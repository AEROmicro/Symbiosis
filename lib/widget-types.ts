...
export const WIDGET_CATALOG: WidgetMeta[] = [
  ...
  type: 'notes-md',
    name: 'Notes (M)',
    description: 'Scratch pad for trade ideas, tickers, or anything else; now medium',
    iconName: 'Terminal',
    defaultW: 8,
    defaultH: 6,
    minW: 8,
  ...
  },
  {
    type: 'todo',
    name: 'To-Do (S)',
    description: 'Persistent to-do list for tasks, trade reminders, and checklists',
    iconName: 'ListTodo',
    defaultW: 4,
    defaultH: 6,
    minW: 4,
  ...
  },
  {
    type: 'todo-lg',
    name: 'To-Do (L)',
    description: 'Wider persistent to-do list — more room for longer task lists',
    iconName: 'ListTodo',
    defaultW: 8,
    defaultH: 7,
    minW: 4,
  ...
  },
  {
    type: 'calculator',
    name: 'Calculator',
    description: 'Basic calculator for quick position sizing and P&L math',
    iconName: 'Calculator',
    defaultW: 4,
    defaultH: 9,
    minW: 4,
  ...
  },
  {
    type: 'news-ticker',
    name: 'News Ticker',
    description: 'Scrolling live news headline bar — full width, one row tall',
    iconName: 'Rss',
    defaultW: 12,
    defaultH: 1,
    minW: 4,
  ...
  },
  {
    type: 'dictionary',
    name: 'Dictionary (S)',
    description: 'Quick access to common finance terms',
    iconName: 'Book',
    defaultW: 4,
    defaultH: 8,
    minW: 4,
  ...
  },
  {
    type: 'dictionary-lg',
    name: 'Dictionary (L)',
    description: 'Quick access to common finance terms; now in a larger size',
    iconName: 'Book',
    defaultW: 8,
    defaultH: 12,
    minW: 8,
...
export const DEFAULT_WIDGET_LAYOUT: WidgetConfig[] = [
  ...
  { id: 'terminal-sm-1',   type: 'terminal-sm',   x: 0, y: 6,  w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'quick-actions-1', type: 'quick-actions', x: 0, y: 15, w: 4, h: 7,  minW: 4, minH: 7  },
  { id: 'system-status-1', type: 'system-status', x: 0, y: 22, w: 4, h: 7,  minW: 4, minH: 7, maxH: 7 },
  { id: 'notes-1',         type: 'notes',         x: 0, y: 29, w: 4, h: 6,  minW: 4, minH: 6, maxH: 6 },
  { id: 'watchlist-1',     type: 'watchlist',     x: 4, y: 1,  w: 8, h: 8,  minW: 4, minH: 8  },
  { id: 'stock-detail-1',  type: 'stock-detail',  x: 4, y: 9,  w: 8, h: 10, minW: 4, minH: 8, maxH: 10 },
  { id: 'heatmap-1',       type: 'heatmap',       x: 4, y: 19, w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'top-movers-1',    type: 'top-movers',    x: 8, y: 19, w: 4, h: 9,  minW: 4, minH: 9  },
  { id: 'help-1',          type: 'help',          x: 4, y: 28, w: 8, h: 7,  minW: 8, minH: 7, maxH: 7 },
]
