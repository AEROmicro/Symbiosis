...
const TOPICS: Topic[] = [
  ...
  {
    id: 'mortgages-101',
    title: 'Mortgages 101: Buying Your First Home',
    description: 'How mortgages work, what to expect during the home-buying process, and how to get the best rate.',
    difficulty: 'Advanced',
    readTime: 6,
    icon: '🏡',
    content: [
      { heading: 'How a Mortgage Works', body: 'A mortgage is a loan specifically used to buy real estate, where the property itself serves as collateral. If you stop making payments, the lender can foreclose — seize and sell the property to recover their money. Most mortgages in the US are 30-year fixed-rate loans, though 15-year and adjustable-rate mortgages (ARMs) are also common. Each monthly payment includes principal (reducing what you owe) and interest. In the early years of a mortgage, the majority of each payment is interest — this gradually shifts toward principal over time.' },
      { heading: 'How Much Home Can You Afford?', body: 'Lenders use two ratios: the front-end ratio (your housing costs divided by gross monthly income, ideally ≤28%) and the back-end ratio (all monthly debt payments divided by gross income, ideally ≤36-43%). A rough rule of thumb: you can generally afford a home priced at 3-4x your annual household income, assuming a 20% down payment. In high-cost areas, this ratio often gets stretched to 5-6x — which requires extremely careful budgeting and a very stable income. Always account for property taxes, insurance, HOA fees, and maintenance (budget 1-2% of home value per year).' },
      { heading: 'The Down Payment and PMI', body: 'A 20% down payment is the gold standard — it avoids Private Mortgage Insurance (PMI), a monthly fee lenders charge when you have less than 20% equity. PMI typically costs 0.5-1.5% of the loan amount per year (on a $400,000 home, that\'s $2,000-$6,000 annually). Many first-time buyers use FHA loans (3.5% down) or conventional loans with 3-10% down, accepting PMI temporarily. PMI can be removed once you reach 20% equity through appreciation or paying down the principal. FHA loans have a slightly different MIP (Mortgage Insurance Premium) structure that can last longer.' },
      { heading: 'Fixed vs Adjustable-Rate Mortgages', body: 'A fixed-rate mortgage locks in your interest rate for the life of the loan — your principal and interest payment never changes. This is ideal in a low-rate environment or if you plan to stay long-term. An adjustable-rate mortgage (ARM) has a fixed period (commonly 5, 7, or 10 years) then adjusts annually based on market rates. ARMs typically start lower than fixed rates and make sense if you plan to sell or refinance before the adjustment period. In a rising-rate environment, ARMs carry significant risk — your payment can jump substantially at each adjustment.' },
      { heading: 'The Mortgage Application Process', body: 'Get pre-approved before house hunting — it shows sellers you\'re serious and establishes your budget. Pre-approval requires W-2s or tax returns, pay stubs, bank statements, and a credit check. Shop multiple lenders: even a 0.25% rate difference saves tens of thousands on a 30-year loan. After your offer is accepted, you\'ll go through underwriting (full verification of your finances) and an appraisal. Closing typically takes 30-45 days and involves signing dozens of documents and paying closing costs — typically 2-5% of the loan amount, covering origination fees, title insurance, appraisal, and prepaid items like property tax escrow.' },
    ],
  },
  {
    id: 'insurance-basics',
    title: 'Insurance Basics: What You Actually Need',
    description: 'The essential insurance policies, what they cover, and how to avoid overpaying.',
    difficulty: 'Intermediate',
    readTime: 5,
    icon: '🛡️',
    content: [
      { heading: 'Why Insurance Matters', body: 'Insurance is a financial tool that trades a small, predictable cost (the premium) for protection against large, unpredictable losses. Without it, a single catastrophic event — serious illness, car accident, house fire, or disability — can wipe out years of savings. The key principle: insure against losses you cannot afford to absorb yourself. A $500 car repair you can handle. A $500,000 medical bill you cannot. Buy insurance to cover the catastrophic, not the inconvenient.' },
      { heading: 'Health Insurance: Your Most Critical Coverage', body: 'Health insurance is the most important insurance most people will ever have. Medical bills are the leading cause of personal bankruptcy in the US. If your employer offers health insurance, enroll — even if the premium feels expensive, the employer typically covers 70-80% of the actual cost. Key terms: Premium (monthly cost), Deductible (amount you pay before insurance kicks in), Copay (fixed amount per visit), Coinsurance (your percentage share after the deductible), and Out-of-Pocket Maximum (the most you\'ll pay in a year — beyond this, insurance covers 100%). Always know your out-of-pocket maximum — this is your worst-case annual medical expense.' },
      { heading: 'Auto Insurance: What\'s Required vs What\'s Smart', body: 'Almost every state requires liability insurance, which pays for damage and injuries you cause to others in an accident. Collision coverage pays for damage to your own car in an accident; comprehensive covers non-collision events (theft, weather, animals). If your car is worth less than $3,000-4,000, dropping collision and comprehensive may make financial sense — the premiums might exceed the payout over a few years. Always carry enough liability insurance to protect your assets: if your net worth is significant, $100,000/$300,000 liability limits are the minimum; consider an umbrella policy. Uninsured/underinsured motorist coverage is highly recommended — about 13% of drivers have no insurance.' },
      { heading: 'Renters and Homeowners Insurance', body: 'Renters insurance is one of the best financial deals available — typically $15-30/month covers your personal belongings against theft, fire, and other perils, plus liability if someone is injured in your home. Many landlords now require it. Homeowners insurance is mandatory with a mortgage and covers the structure, personal property, liability, and additional living expenses if your home becomes uninhabitable. Critically: standard homeowners policies do NOT cover floods or earthquakes — these require separate policies. If you\'re in a flood zone, flood insurance through the NFIP or private insurers is essential.' },
      { heading: 'Life and Disability Insurance', body: 'Life insurance is essential if others depend on your income — a spouse, children, or aging parents. Term life insurance provides coverage for a specific period (10, 20, 30 years) and is inexpensive for healthy young people. A $500,000 30-year term policy might cost $25-40/month for a healthy 30-year-old. Whole life and universal life policies combine insurance with an investment component but are far more expensive and rarely the right choice for most people. Disability insurance is often overlooked but critically important — you\'re statistically much more likely to become disabled than to die during your working years. Long-term disability insurance (covering 60-70% of income if you can\'t work) is valuable if not provided by your employer.' },
    ],
  },
  {
    id: 'etfs-explained',
    title: 'ETFs Explained: The Smarter Way to Invest',
    description: 'What exchange-traded funds are, how they differ from mutual funds, and why most investors should use them.',
    difficulty: 'Beginner',
    readTime: 4,
    icon: '📊',
    content: [
      { heading: 'What Is an ETF?', body: 'An exchange-traded fund (ETF) is a basket of securities — stocks, bonds, commodities, or a mix — that trades on a stock exchange just like an individual stock. When you buy one share of an S&P 500 ETF, you own a tiny slice of all 500 companies in the index. ETFs combine the diversification of a mutual fund with the trading flexibility of a stock. They were invented in 1993 and have grown to hold over $10 trillion in assets globally, becoming one of the most popular investment vehicles in history.' },
      { heading: 'ETFs vs Mutual Funds', body: 'Both ETFs and mutual funds pool investors\' money to buy a diversified portfolio. Key differences: ETFs trade throughout the day on exchanges (like stocks), while mutual funds only price and trade once per day after market close. ETFs are typically more tax-efficient because of their unique creation/redemption mechanism. ETFs usually have lower expense ratios — Vanguard\'s VOO (S&P 500 ETF) has an expense ratio of just 0.03%, compared to 0.5-1.5% for many actively managed mutual funds. That 1% difference costs tens of thousands of dollars over 30 years.' },
      { heading: 'Types of ETFs', body: 'Index ETFs track a market index (S&P 500, NASDAQ, Russell 2000) and are the simplest and most recommended type for most investors. Sector ETFs focus on specific industries: XLK (technology), XLF (financials), XLE (energy). Bond ETFs hold government or corporate bonds and provide income and stability. International ETFs give exposure to foreign markets (VEA for developed markets, VWO for emerging markets). Thematic ETFs target specific trends (clean energy, AI, cannabis). Inverse and leveraged ETFs are speculative tools not suitable for long-term investing. For most people, a simple combination of a total US market ETF and an international ETF is sufficient.' },
      { heading: 'How to Evaluate an ETF', body: 'Expense ratio: the annual cost as a percentage of assets. Lower is almost always better — look for under 0.20% for index ETFs. Tracking error: how closely the ETF follows its index. Top ETFs track almost perfectly. Liquidity: higher trading volume means tighter bid-ask spreads and easier trading. AUM (assets under management): larger funds are more established and less likely to close. Look for funds with at least $500M AUM. The underlying index: understand what the ETF actually holds. Some "S&P 500" ETFs hold slightly different components than others. For most investors, sticking to funds from Vanguard, BlackRock (iShares), or State Street (SPDR) is a safe starting point.' },
      { heading: 'Building a Simple ETF Portfolio', body: 'You don\'t need dozens of ETFs. Warren Buffett recommended putting 90% in a low-cost S&P 500 index fund and 10% in short-term government bonds. A slightly more diversified approach: 60% VTI (total US stock market), 30% VXUS (international stocks), 10% BND (bonds) — this covers virtually every publicly traded company in the world. Rebalance once a year to maintain your target allocation. Resist the urge to constantly tinker — studies consistently show that buy-and-hold investors outperform those who trade frequently. Set it, forget it, and let compound growth do the work.' },
    ],
  },
  {
    id: 'student-loans',
    title: 'Student Loans: Repayment Strategies',
    description: 'Federal vs private loans, income-driven repayment, forgiveness programs, and how to pay off debt faster.',
    difficulty: 'Intermediate',
    readTime: 5,
    icon: '🎓',
    content: [
      { heading: 'Federal vs Private Student Loans', body: 'Federal student loans come from the US government and offer significant protections: fixed interest rates, income-driven repayment plans, deferment and forbearance options, and potential forgiveness programs. Private student loans come from banks and credit unions — they often have higher rates (especially for variable-rate loans), fewer protections, and no forgiveness options. Always exhaust federal loan options before taking private loans. If you have private loans, refinancing to a lower rate makes sense if you have good credit and a stable income, but NEVER refinance federal loans to private — you lose all federal protections permanently.' },
      { heading: 'Federal Repayment Plans', body: 'Standard repayment: fixed payments over 10 years — least total interest paid. Graduated repayment: payments start low and increase every 2 years — good if you expect income to grow. Extended repayment: up to 25 years for lower monthly payments — more total interest. Income-Driven Repayment (IDR) plans — SAVE, PAYE, IBR — cap payments at 5-10% of discretionary income and forgive remaining balances after 20-25 years. SAVE (Saving on a Valuable Education) is currently the most generous IDR plan, especially for undergrad borrowers. IDR plans are essential if your debt is high relative to your income.' },
      { heading: 'Public Service Loan Forgiveness (PSLF)', body: 'PSLF forgives remaining federal student loan balances after 10 years (120 payments) of working full-time for a qualifying employer — government agencies, public schools, non-profits. Critically: you must be on an IDR plan (not standard repayment) and work for a qualifying employer the entire 10 years. PSLF is tax-free forgiveness — a massive benefit. If you work in public service, this program can be transformative. Common qualifying employers: public schools and universities, government agencies at any level, non-profit hospitals, and 501(c)(3) organizations. Submit the Employment Certification Form annually to track progress.' },
      { heading: 'Should You Pay Off Loans Early?', body: 'Whether to aggressively pay off student loans depends on your interest rate. Federal loans typically have rates of 5-7% (post-2022). If your loan rate is below ~5%, invest the difference instead — you\'ll likely earn more in the market over the long run. If your rate is above 7%, pay it down aggressively. Credit card debt (20%+ APR) should always be prioritized over student loans. High-earning borrowers with large federal loan balances who plan to pursue PSLF should NOT overpay — every extra dollar reduces potential forgiveness. Calculate your expected PSLF forgiveness amount before making extra payments.' },
      { heading: 'Refinancing: When It Makes Sense', body: 'Refinancing private student loans to a lower rate almost always makes sense if your credit score is above 700 and you have steady income. Typical refinanced rates for strong borrowers: 5-8% fixed, 4-7% variable. Companies like Earnest, SoFi, and Laurel Road offer competitive refinancing. NEVER refinance federal loans unless you have high-rate Graduate PLUS loans, no intention of pursuing PSLF, and a very stable high income. Once refinanced to private, you permanently lose access to IDR plans, forgiveness programs, and federal deferment/forbearance options. The potential interest savings must be weighed against these lost benefits.' },
    ],
  },
  {
    id: 'side-income-taxes',
    title: 'Side Income & Freelance: Tax Guide',
    description: 'How self-employment taxes work, what you can deduct, and how to avoid IRS surprises.',
    difficulty: 'Intermediate',
    readTime: 4,
    icon: '💼',
    content: [
      { heading: 'You\'re Running a Business', body: 'When you earn money outside a regular W-2 job — freelancing, consulting, selling on Etsy, driving for Uber, renting on Airbnb, or any other side hustle — you\'re self-employed in the eyes of the IRS. This has significant tax implications. Unlike employees, nobody withholds taxes for you. You\'re responsible for tracking income, calculating taxes, making quarterly payments, and filing a Schedule C with your tax return. Treating your side income as a business from the start (keeping records, opening a separate bank account) saves enormous headaches at tax time.' },
      { heading: 'Self-Employment Tax: The Painful Truth', body: 'As a W-2 employee, you pay 7.65% FICA tax (Social Security + Medicare) and your employer pays a matching 7.65%. As self-employed, you pay BOTH sides: 15.3% self-employment (SE) tax on net self-employment income up to the Social Security wage base ($168,600 in 2024), plus 2.9% Medicare tax on everything above. On top of SE tax, add your regular income tax bracket. Combined, self-employment income at moderate income levels often faces effective tax rates of 35-45%. This is why setting aside 25-30% of every freelance payment for taxes is essential.' },
      { heading: 'Quarterly Estimated Tax Payments', body: 'When you expect to owe $1,000 or more in federal taxes from self-employment, you must pay quarterly estimated taxes. Missing these payments results in underpayment penalties. The 2024 due dates are: April 15 (Q1), June 17 (Q2), September 16 (Q3), and January 15 (Q4 of prior year). Use IRS Form 1040-ES to calculate payments. A simple method: pay 100% of last year\'s total tax liability (110% if your AGI exceeded $150,000) in four equal installments — this "safe harbor" protects you from underpayment penalties regardless of how much you actually earn. Use IRS Direct Pay to submit electronically.' },
      { heading: 'Business Deductions You Can Take', body: 'Self-employed people can deduct ordinary and necessary business expenses, which directly reduce taxable income. Common deductions: home office (dedicated space used exclusively for business — calculate square footage as % of home for rent/utilities/depreciation), equipment and software (computers, phones, subscriptions), car mileage (67 cents/mile in 2024 for business driving — keep a log), professional development (courses, books, conferences), health insurance premiums (100% deductible for self-employed), and 50% of self-employment tax itself. Good recordkeeping is essential — use accounting software like Wave (free) or QuickBooks to track everything throughout the year.' },
    ],
  },
]
